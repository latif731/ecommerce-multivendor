...
const ProductDetailsCard = ({setOpen, data}) => {
    console.log("data di Product detail card",data)
    const [count, setCount] = useState(1)
    const [click, setClick] = useState(false)
    const {cart} = useSelector((state) =>  state.cart)
    const {wishlist} = useSelector((state) => state.wishlist)
    console.log("wishlist di product detail card", wishlist)
    console.log("ini keranjang", cart)
    ...
    const addToCartHandler = (id) =>{
        const isItemsExists = cart && cart.find((i) =>  i._id === id)
        if(isItemsExists){
                        ...
                        <div className='block w-full 800px:flex '>
                            <div className='w-full 800px:w-[50%]'>
                                ...
                                <div className='flex'>
                                    ...
                                    <h5 className='text-[16px] text-[red] mt-5 font-bold'>
